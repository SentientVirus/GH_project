...
for i in range(len(GH_types)): #Loop through gene types
    ...
    if i == 0: #If the gene is GS1
        ...
        axs[0, i+1].axline(xy1=(0, intercept2), color = 'darkorange', slope=slope2, label=f'$y = {slope2:.3f}x {intercept2:+.3f}$\n$R² = {r2[0]**2:.3f}, p$-$value = {r2[1]:.3f}$', zorder = 5)
        ...
        axs[1, i].axline(xy1=(0, intercept2_1), color = 'darkorange', slope=slope2_1, label=f'$y = {slope2_1:.3f}x {intercept2_1:+.3f}$\n$R² = {r2_1[0]**2:.3f}, p$-$value = {r2_1[1]:.3f}$', zorder = 5)
        ...
        axs[1, i+1].axline(xy1=(0, intercept2_2), color = 'darkorange', slope=slope2_2, label=f'$y = {slope2_2:.3f}x {intercept2_2:+.3f}$\n$R² = {r2_2[0]**2:.3f}, p$-$value = {r2_2[1]:.3f}$', zorder = 5)
        ...
        axs[0, i+1].axline(xy1=(0, intercept1), color = 'darkorange', slope=slope1, label=f'$y = {slope1:.3f}x {intercept1:+.3f}$\n$R² = {r1[0]**2:.3f}, p$-$value = {r1[1]:.3f}$', zorder = 5)
        ...
        r2 = pearsonr(x2_list, dN2_list)
        slope2, intercept2 = np.polyfit(x2_list, dN2_list, 1)
        axs[0, i+2].axline(xy1=(0, intercept2), color = 'darkorange', slope=slope2, label=f'$y = {slope2:.3f}x {intercept2:+.3f}$\n$R² = {r2[0]**2:.3f}, p$-$value = {r2[1]:.3f}$', zorder = 5)
        ...
        r2_1 = pearsonr(x1_list, y1_list)
        slope2_1, intercept2_1 = np.polyfit(x1_list, y1_list, 1)
        axs[1, i+1].axline(xy1=(0, intercept2_1), color = 'darkorange', slope=slope2_1, label=f'$y = {slope2_1:.3f}x {intercept2_1:+.3f}$\n$R² = {r2_1[0]**2:.3f}, p$-$value = {r2_1[1]:.3f}$', zorder = 5)
        axs[1, i+1].legend(loc = 'upper right', frameon = False)
        axs[1, i+1].plot([0, 1], [0, 1], color = 'lightgrey')
        ...
        r2_2 = pearsonr(x2_list, y2_list)
        slope2_2, intercept2_2 = np.polyfit(x2_list, y2_list, 1)
        axs[1, i+2].axline(xy1=(0, intercept2_2), color = 'darkorange', slope=slope2_2, label=f'$y = {slope2_2:.3f}x {intercept2_2:+.3f}$\n$R² = {r2_2[0]**2:.3f}, p$-$value = {r2_2[1]:.3f}$', zorder = 5)
        ...
        r2 = pearsonr(x2_list, dN2_list)
        slope2, intercept2 = np.polyfit(x2_list, dN2_list, 1)
        axs[0, i+3].axline(xy1=(0, intercept2), color = 'darkorange', slope=slope2, label=f'$y = {slope2:.3f}x {intercept2:+.3f}$\n$R² = {r2[0]**2:.3f}, p$-$value = {r2[1]:.3f}$', zorder = 5)
        ...
        axs[0, i+4].axline(xy1=(0, intercept3), color = 'darkorange', slope=slope3, label=f'$y = {slope3:.3f}x {intercept3:+.3f}$\n$R² = {r3[0]**2:.3f}, p$-$value = {r3[1]:.3f}$', zorder = 5)
        ...
        r2_1 = pearsonr(x1_list, y1_list)
        slope2_1, intercept2_1 = np.polyfit(x1_list, y1_list, 1)
        axs[1, i+2].axline(xy1=(0, intercept2_1), color = 'darkorange', slope=slope2_1, label=f'$y = {slope2_1:.3f}x {intercept2_1:+.3f}$\n$R² = {r2_1[0]**2:.3f}, p$-$value = {r2_1[1]:.3f}$', zorder = 5)
        axs[1, i+2].legend(loc = 'upper right', frameon = False)
        axs[1, i+2].plot([0, 1], [0, 1], color = 'lightgrey')
        ...
        r2_2 = pearsonr(x2_list, y2_list)
        slope2_2, intercept2_2 = np.polyfit(x2_list, y2_list, 1)
        axs[1, i+3].axline(xy1=(0, intercept2_2), color = 'darkorange', slope=slope2_2, label=f'$y = {slope2_2:.3f}x {intercept2_2:+.3f}$\n$R² = {r2_2[0]**2:.3f}, p$-$value = {r2_2[1]:.3f}$', zorder = 5)
        ...
        axs[1, i+4].axline(xy1=(0, intercept2_3), color = 'darkorange', slope=slope2_3, label=f'$y = {slope2_3:.3f}x {intercept2_3:+.3f}$\n$R² = {r2_3[0]**2:.3f}, p$-$value = {r2_3[1]:.3f}$', zorder = 5)
        ...
        axs[0, ni].axline(xy1=(0, intercept), color = 'darkorange', slope=slope, label=f'$y = {slope:.3f}x {intercept:+.3f}$\n$R² = {r[0]**2:.3f}, p$-$value = {r[1]:.3f}$', zorder = 5)
        ...
        axs[1, ni].axline(xy1=(0, intercept), color = 'darkorange', slope=slope, label=f'$y = {slope2:.3f}x {intercept2:+.3f}$\n$R² = {r2[0]**2:.3f}, p$-$value = {r2[1]:.3f}$', zorder = 5)
