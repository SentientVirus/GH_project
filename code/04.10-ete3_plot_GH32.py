...
This script creates graphical representations of the tree of all
GH32 genes.
...
treefile = os.path.expanduser('~') + '/GH_project/data/fasta/GH32/trees/GH32_repset.mafft.faa.treefile' 
outfile = os.path.expanduser('~') + '/GH_project/plots/trees/GH32_tree.png'
...
outnode = t.get_common_ancestor('A1404_13450', 'H4B503X_12760')
