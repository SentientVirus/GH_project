...
acc_list = ['WP_353322098.1', 'WP_353317313.1', 'WP_249510840.1', 
            ...
            'WP_203617613.1', 'WP_265478802.1', 'WP_412129441.1',
            'WP_412142894.1', 'WP_172692410.1', 'WP_261912693.1', 
            'WP_036092298.1', 'WP_111303383.1', 'WP_273750349.1',
            'WP_367114384.1', 'WP_080732772.1', 'WP_010690266.1',
            'WP_064213163.1', 'WP_165844525.1', 'WP_094511690.1',
...
with open(outfile) as handle:
    for record in SeqIO.parse(handle, 'fasta'):
        ...
        new_description = f'{record.id}_{genus}_{epithet}'
